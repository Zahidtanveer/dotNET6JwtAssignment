...
using DotNET6JwtAssignment.Common.Mappings;
using DotNET6JwtAssignment.Common.Models;
using DotNET6JwtAssignment.Data;
using DotNET6JwtAssignment.Data.UnitOfWork;
...
namespace DotNET6JwtAssignment.API.Extensions
{
    public static class ServiceCollectionExtension
    {
        ...
        public static void ConfigurePostgreSQL(this IServiceCollection services, IConfiguration configuration) =>
            services.AddDbContext<ApplicationDbContext>(
                opts => opts.UseNpgsql(configuration.GetConnectionString("dbConnection"),
                    b => b.MigrationsAssembly("DotNET6JwtAssignment.Data")));
        ...
        public static void ConfigureMapping(this IServiceCollection services)
        {
            ...
            var mapperConfig = new MapperConfiguration(map =>
            {
                ...
                map.AddProfile<VisitsMappingProfile>();
            });
        ...
        public static void ConfigureSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = ".NET 6 Jwt Assignment API",
                    Version = "v1",
                    Description = ".NET 6 Jwt Assignment API Services.",
        ...
        public static void RegisterValidationServices(this IServiceCollection services)
        {
